...
module pxpotrf_tests
   ...
   #:for dtype in precision
      #:for type in types
         ...
         use dlaf_fortran, only: dlaf_p${name}$potrf
      #:endfor
   #:endfor
   ...
   #:for dtype in precision
      #:for type in types
         ...
         subroutine p${name}$potrf_test
            ...
            call blacs_exit(1)
            call teardown_mpi()
         end subroutine p${name}$potrf_test

      #:endfor
   #:endfor
end module pxpotrf_tests
